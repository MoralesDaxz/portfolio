    ...
    <section className='w-full min-h-screen flex flex-col items-center ' id='projects'>
      ...
      <article className='w-full flex flex-wrap gap-y-4 sm:gap-x-3 md:gap-x-5 justify-center '>
        <CardProject
          ...
          {cafeAlturaData.skills.map((item,index) => { return <TagSkill classTag={'text-bondiBlue-500 items-center'} key={item} title={item} show={true}/> })}
        </CardProject>
        ...
        <CardProject
          ...
          {globalLogisticData.skills.map((item,index) => { return <TagSkill classTag={'text-bondiBlue-500 items-center'} key={item} title={item} show={true}/> })}
        </CardProject>
        ...
        <CardProject
          ...
          prf={pokemonData.prf}>
          {pokemonData.skills.map((item,index) => { return <TagSkill classTag={'text-bondiBlue-500 items-center'} key={item} title={item} show={true}/> })}
        </CardProject>
        ...
        <CardProject
          ...
          srcImg={aujData.img}
          prf={aujData.prf}>
          {aujData.skills.map((item,index) => { return <TagSkill classTag={'text-bondiBlue-500 items-center'} key={item} title={item} show={true}/> })}
        </CardProject>
      </article>
    </section>
  )
